    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_name', models.CharField(default=None, max_length=50, unique=True)),
                ('project_owner', models.CharField(default=None, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.TextField(default='working on', max_length=1000, null=True)),
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_fields', to='HR_management_app.project')),
                ('team', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
                ('team_leader', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='team_leader', to='HR_management_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
